...
// @Router			/codesystem/icd [get]
func (c *codeSystemController) ListICD(ctx *gin.Context) {
	var size int
	...
	url := "https://backend-kl02.onrender.com/api/v1/codesystem/icd"
	codeSystem, err := c.codeSystemService.ListICD(size, url)
	if err != nil {
